    ...
    <div className='container mx-auto mt-10'>
        <div className='grid md:grid-cols-2 bg-black gap-8 h-[240px] md:h-[180px] text-center justify-between items-center rounded-3xl'>
            ...
            <div className='flex flex-col items-center gap-4 mb-4'>
                <button className='bg-gray-100 h-12 w-[350px] md:w-[394px] rounded-3xl flex items-center pl-6 gap-2'><Image src={email} alt='email' /><input type=" text" placeholder='Enter your email' /></button>
