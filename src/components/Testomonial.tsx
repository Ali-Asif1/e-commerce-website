      ...
      <div className="px-4 sm:px-8 md:px-12 lg:px-16 py-16 ">
        ...
        <div className="">
          <div className="flex justify-around gap-12">
            <div className="w-full sm:w-[336px] space-y-2 border-2 border-gray-300 p-4 rounded-md">
            ...
            <div className="w-[336px] hidden sm:block space-y-2 border-2 border-gray-300 p-4 rounded-md">
            ...
            <div className="w-[336px] hidden lg:block space-y-2 border-2 border-gray-300 p-4 rounded-md">
              <Image src={star} alt="star" className="mb-1" />
              <h2 className="tracking-wider text-xl flex gap-2 font-bold">
                James L.
                <Image src={right} alt="right" />
